...
for rr in range(0,len(rho_set)):
    ...
    for ii in range(1,R_num+1):
        ...
        file_path = 'E:\\黄清扬\\SpectrumPrediction_2024\\MATLABoutput\\' + experiment + '\\Mat_rho' + str(rho) + '_R'+str(R_num)+'_SNR20_sinc2C\\'
        ...
        filename3 = 'NMFCPD_LSTM_rho'+str(rho) + '_timestep=20_online_%d.mat'%input_index
